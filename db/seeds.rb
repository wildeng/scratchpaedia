...
Article.create! title: "Superman", user_id: user.id, content: <<-ARTICLE
...
Article.create! title: "Krypton", user_id: user.id, content: <<-ARTICLE
...
Article.create! title: "Lex Luthor", user_id: user.id, content: <<-ARTICLE
...
Article.create! title: "Robin", user_id: user.id, content: <<-ARTICLE
